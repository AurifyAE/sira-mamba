    ...
    return (
        <section className="bg-[#FFEECC] py-20 relative">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                {/* Top Right Button */}
                <div className="absolute top-22 right-23 md:right-32">
                    <Link 
                        to="/products"
                        className="w-8 h-8 md:w-14 md:h-14 rounded-full bg-white flex items-center justify-center transition-all duration-200 hover:bg-[#DCBC7C] cursor-pointer shadow-[2px_1px_2px_#00000030,-2px_-1px_2px_#00000030]"
                    >
                        <svg className="w-5 h-4 md:w-7 md:h-7 text-black" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
                            <path d="M9 5l7 7-7 7" />
                        </svg>
                    </Link>
                </div>
